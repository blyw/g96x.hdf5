...
public:
	...
	struct GenericParameters {
		...
		//angle cut-off e.g. used in hbond
        ...
        std::vector<std::vector<std::vector<std::vector<long>> >> histogram2D;
        ...
        Eigen::Matrix<double, 1, Eigen::Dynamic> rmsf;
	};
	...
	struct FrameGeometric {
        ...
        //frameout
        Eigen::Vector3d frame_cog;

		//rmsd
        double rmsd;

        //rmsf
        Eigen::Matrix<long, 1, Eigen::Dynamic> mi_tmp;
